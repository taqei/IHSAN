...
public class Isfollower extends StringRequest {
    private static final String URL = Help.getURL() + "apiprofil/isfollower";


    public Isfollower(Utilisateur me, Profile other, Response.Listener<String> listener, Response.ErrorListener errorListener) {
